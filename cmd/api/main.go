...
func main() {
	...
	handler := handler.New(usecase.User, usecase.MainCateg, usecase.SubCateg, usecase.Transaction, usecase.Icon, usecase.UserIcon, usecase.InitData, usecase.Stock, usecase.HistoricalPortfolio)
