...
// S3PreSigner is an autogenerated mock type for the S3PreSigner type
type S3PreSigner struct {
	mock.Mock
}

// PresignGetObject provides a mock function with given fields: ctx, params, optFns
func (_m *S3PreSigner) PresignGetObject(ctx context.Context, params *s3.GetObjectInput, optFns ...func(*s3.PresignOptions)) (*v4.PresignedHTTPRequest, error) {
...
func (_m *S3PreSigner) PresignPutObject(ctx context.Context, params *s3.PutObjectInput, optFns ...func(*s3.PresignOptions)) (*v4.PresignedHTTPRequest, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
// NewS3PreSigner creates a new instance of S3PreSigner. It also registers a testing interface on the mock and a cleanup function to assert the mocks expectations.
// The first argument is typically a *testing.T value.
func NewS3PreSigner(t interface {
	mock.TestingT
	Cleanup(func())
}) *S3PreSigner {
	mock := &S3PreSigner{}
