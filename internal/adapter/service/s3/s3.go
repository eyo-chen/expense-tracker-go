...
func New(bucket string, s3Client interfaces.S3Client, presignClient interfaces.S3PresignClient) *s3Service {
	return &s3Service{bucket: bucket, s3Client: s3Client, presignClient: presignClient}
}

func (s *s3Service) PutObjectUrl(ctx context.Context, objectKey string, lifetimeSecs int64) (string, error) {
...
func (s *s3Service) GetObjectUrl(ctx context.Context, objectKey string, lifetimeSecs int64) (string, error) {
