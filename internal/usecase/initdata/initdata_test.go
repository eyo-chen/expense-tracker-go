...
func create_NoError_CreateSuccessfully(s *InitDataSuite, desc string) {
	...
	mockMainCategs := []domain.MainCateg{
		{Name: "food", IconType: domain.IconTypeDefault, IconData: "url1", Type: domain.TransactionTypeExpense},
		{Name: "transportation", IconType: domain.IconTypeDefault, IconData: "url4", Type: domain.TransactionTypeExpense},
		{Name: "utilities", IconType: domain.IconTypeDefault, IconData: "url9", Type: domain.TransactionTypeExpense},
		{Name: "housing", IconType: domain.IconTypeDefault, IconData: "url3", Type: domain.TransactionTypeExpense},
		{Name: "clothing", IconType: domain.IconTypeDefault, IconData: "url2", Type: domain.TransactionTypeExpense},
		{Name: "entertainment", IconType: domain.IconTypeDefault, IconData: "url6", Type: domain.TransactionTypeExpense},
		{Name: "gifts", IconType: domain.IconTypeDefault, IconData: "url7", Type: domain.TransactionTypeExpense},
		{Name: "education", IconType: domain.IconTypeDefault, IconData: "url5", Type: domain.TransactionTypeExpense},
		{Name: "insurance", IconType: domain.IconTypeDefault, IconData: "url10", Type: domain.TransactionTypeExpense},
		{Name: "debt", IconType: domain.IconTypeDefault, IconData: "url11", Type: domain.TransactionTypeExpense},
		{Name: "healthcare", IconType: domain.IconTypeDefault, IconData: "url8", Type: domain.TransactionTypeExpense},
		{Name: "others", IconType: domain.IconTypeDefault, IconData: "url14", Type: domain.TransactionTypeExpense},
		{Name: "salary", IconType: domain.IconTypeDefault, IconData: "url12", Type: domain.TransactionTypeIncome},
		{Name: "investment", IconType: domain.IconTypeDefault, IconData: "url15", Type: domain.TransactionTypeIncome},
		{Name: "others", IconType: domain.IconTypeDefault, IconData: "url14", Type: domain.TransactionTypeIncome},
	}
	mockMainCategsWithID := []domain.MainCateg{
		{ID: 1, Name: "food", IconType: domain.IconTypeDefault, IconData: "url1", Type: domain.TransactionTypeExpense},
		{ID: 2, Name: "transportation", IconType: domain.IconTypeDefault, IconData: "url4", Type: domain.TransactionTypeExpense},
		{ID: 3, Name: "utilities", IconType: domain.IconTypeDefault, IconData: "url9", Type: domain.TransactionTypeExpense},
		{ID: 4, Name: "housing", IconType: domain.IconTypeDefault, IconData: "url3", Type: domain.TransactionTypeExpense},
		{ID: 5, Name: "clothing", IconType: domain.IconTypeDefault, IconData: "url2", Type: domain.TransactionTypeExpense},
		{ID: 6, Name: "entertainment", IconType: domain.IconTypeDefault, IconData: "url6", Type: domain.TransactionTypeExpense},
		{ID: 7, Name: "gifts", IconType: domain.IconTypeDefault, IconData: "url7", Type: domain.TransactionTypeExpense},
		{ID: 8, Name: "education", IconType: domain.IconTypeDefault, IconData: "url5", Type: domain.TransactionTypeExpense},
		{ID: 9, Name: "insurance", IconType: domain.IconTypeDefault, IconData: "url10", Type: domain.TransactionTypeExpense},
		{ID: 10, Name: "debt", IconType: domain.IconTypeDefault, IconData: "url11", Type: domain.TransactionTypeExpense},
		{ID: 11, Name: "healthcare", IconType: domain.IconTypeDefault, IconData: "url8", Type: domain.TransactionTypeExpense},
		{ID: 12, Name: "others", IconType: domain.IconTypeDefault, IconData: "url14", Type: domain.TransactionTypeExpense},
		{ID: 13, Name: "salary", IconType: domain.IconTypeDefault, IconData: "url12", Type: domain.TransactionTypeIncome},
		{ID: 14, Name: "investment", IconType: domain.IconTypeDefault, IconData: "url15", Type: domain.TransactionTypeIncome},
		{ID: 15, Name: "others", IconType: domain.IconTypeDefault, IconData: "url14", Type: domain.TransactionTypeIncome},
	}
